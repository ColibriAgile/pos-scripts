if object_id('sp_apagar_schema') is not null 
  drop procedure sp_apagar_schema
go

CREATE PROCEDURE sp_apagar_schema
(
...
/*
exec dbo.sp_apagar_schema 'fiscal'
exec dbo.sp_apagar_schema 'gaveta'
exec dbo.sp_apagar_schema 'balanca'
*/