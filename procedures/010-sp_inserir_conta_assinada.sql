...
begin
  begin tran
    ...
    insert into pendura 
      (cliente_id, dt_hr_pendura, vl_total, operacao_id, cancelado, saldo, dt_contabil, movimento_id) 
    output inserted.pendura_id
    values 
      (@clienteId, getdate(), @valor, @operacaoId, 0, @saldo, @dtContabil, @movimentoId)
  commit          
end
