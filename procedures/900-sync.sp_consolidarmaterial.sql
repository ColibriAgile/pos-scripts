if object_id('sync.sp_consolidarmaterial') is not null
  drop procedure sync.sp_consolidarmaterial
go

create procedure sync.sp_consolidarmaterial @loja_id int, @rede_id int
as
begin
  set nocount on
